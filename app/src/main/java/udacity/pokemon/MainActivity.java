...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetPokemon extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String jsonString = "";
            try {
                // By making the HTTP Request, we can successfully request information from the URL, and start grabbing necessary data to display in our app.
                // This is the first step we must take to start our process of HTTP Networking
